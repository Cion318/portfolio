  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute inset-0 h-full w-full rounded-xl bg-black opacity-0 group-hover:opacity-40" />
        ...
        >
          <div className="absolute inset-0 z-[-1] h-full w-full rounded-xl bg-black opacity-80" />
